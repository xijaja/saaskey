...
const useOptionalPromptInputAttachmentsContext = () => {
...
export const usePromptInputAttachments = () => {
  const context = useOptionalPromptInputAttachmentsContext();
  if (!context) {
    throw new Error(
...
export const PromptInputHeader = ({
  ...
  const attachments = useOptionalPromptInputAttachmentsContext();
