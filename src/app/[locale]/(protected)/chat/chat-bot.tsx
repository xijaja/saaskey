...
export default function ChatBot() {
  ...
  return (
    <div className="flex size-full flex-col overflow-hidden">
      <div
        className="flex-1 overflow-y-auto px-4 [-ms-overflow-style:none] [scrollbar-width:none] md:px-6 [&::-webkit-scrollbar]:hidden"
      ...
      >
        {messages.length > 0 ? (
          ...
          <div className="flex size-full flex-col items-center justify-center py-24">
            <h2 className="py-6 text-center font-bold text-4xl">👋 Hello，希嘉嘉</h2>
            <p className="text-center text-lg text-muted-foreground">
              What are you interested in today? Ask me anything you want to know.
            </p>
          </div>
        )}
      </div>
